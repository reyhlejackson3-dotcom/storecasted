...
export interface Product {
  ...
  /**
   * Current on-hand count. null = this item doesn't track inventory in Square,
   * which is common. Never treat that as zero — it would fire false alarms.
   */
  stock: number | null;
...
export interface ProductMetrics {
  ...
  /** Carried through so a suggested order can be priced. null = never entered. */
  unitCostCents: number | null;
  unitsSold: number;
  returns: number;
  lastReceivedAt: string | null;
